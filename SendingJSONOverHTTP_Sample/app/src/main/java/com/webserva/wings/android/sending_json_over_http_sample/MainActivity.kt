package com.webserva.wings.android.sending_json_over_http_sample
...
class MainActivity : AppCompatActivity() {
    ...
    // デフォルトのURLを定数として定義
    companion object {
        const val DEFAULT_SERVER_URL = "https://example.com/api" // 任意のデフォルトURLを設定
    }
...
@Composable
fun GreetingPreview() {
    SendingJSONOverHTTP_SampleTheme {
        Greeting("Android")
    }
}